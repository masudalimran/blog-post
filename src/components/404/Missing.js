...
import "../../style/missingStyle.css";
import { Link } from "react-router-dom";

export default function Missing() {
  return (
    <div className="missingDiv">
      <h1 className="missingH1">404</h1>
      <svg
        className="missingSvg"
        width="1123"
        height="837"
      ...
      <div className="textMissing">
        <h1 className="missingH1">404 Error</h1>
        <h2>Couldn't launch :(</h2>
        <h3>
          Page Not Found - lets take you{" "}
          <Link className="missingAnchor" to="/">
            BACK
          </Link>
        </h3>
      </div>
